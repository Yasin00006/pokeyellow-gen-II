...
; Route 3
	...
	db 11, METAPOD, PARAS, METAPOD, 0
; Mt. Moon 1F
	db $FF, 10, WEEDLE, 11, BEEDRILL, 0
	db $FF, 10, CATERPIE, 11, BUTTERFREE, 0
; Route 24
	db 14, BUTTERFREE, BEEDRILL, 0
; Route 6
	db 18, BUTTERFREE, BEEDRILL, 0
	db 19, VENONAT, SCYTHER, 0
; Unused
...
; Route 9
	db 21, RATICATE, DIGLETT, EKANS, SANDSHREW, 0
; Route 12
...
; Postgame Fight
	...
	db $FF, 78, TAUROS, 77, ARCANINE, 77, EXEGGUTOR, 77, GYARADOS, 78, SNORLAX, 81, DRAGONITE, 0
...
ErikaData:
	db $FF, 33, TANGELA, 34, VICTREEBEL, 32, IVYSAUR, 36, VILEPLUME, 0

KogaData:
	db $FF, 45, GOLBAT, 43, MUK, 44, TENTACRUEL, 44, WEEZING, 48, VENOMOTH, 0
...
AgathaData:
	db $FF, 57, GENGAR, 58, GOLBAT, 57, MAROWAK, 58, ARBOK, 60, GENGAR, 0
