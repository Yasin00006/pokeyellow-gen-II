...
IndigoPlateauLobbyClerkText::
	script_mart GREAT_BALL, ULTRA_BALL, HYPER_POTION, FULL_RESTORE, MAX_POTION, REVIVE, FULL_HEAL, MAX_REPEL, MOON_STONE, TM_SUBMISSION, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_DREAM_EATER, TM_ROCK_SLIDE
